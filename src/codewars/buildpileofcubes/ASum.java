...
public class ASum {
    ...
    public static int getNextIncrement(long targetNum, long currentNum, int lastIncrement) {
    ...
    // not used now - kept here for posterity!
    public static long calcVolume(int numCubes) {
        ...
        /*
         * for (int i = 1; i <= numCubes; i++) { long blockVolume = (long)
         * Math.pow(i, 3); buildingVolume += blockVolume; //
